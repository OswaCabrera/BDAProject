...
LOB (FOTO, COMPROBANTE_DOMICILIO, IDENTIFICACION) 
    STORE AS SECUREFILE SFSEGNAME(TABLESPACE MEDIA
      RETENTION AUTO
      CACHE LOGGING
...
CREATE TABLE DEPOSITO(
    ...
    CREATE UNIQUE INDEX DEPOSITO_PK ON 
...
CREATE TABLE EMAIL(
    ...
    CREATE UNIQUE INDEX EMAIL_PK ON 
        EMAIL(EMAIL_ID)
        TABLESPACE INDEXES
    ), 
...
CREATE TABLE IMAGEN(
    ...
    CREATE UNIQUE INDEX IMAGEN_PK ON 
        IMAGEN(IMAGEN_ID)
        TABLESPACE INDEXES
    ),
...
CREATE TABLE TARJETA(
    ...
    CONSTRAINT TARJETA_PK PRIMARY KEY (TARJETA_ID)
      CREATE UNIQUE INDEX TARJETA_PK ON 
        TARJETA(TARJETA_ID)
        TABLESPACE INDEXES
      ),
